...
static SDL_VideoDevice *FB_CreateDevice(int devindex)
{
	...
	SDL_putenv("SDL_MOUSEDRV=none");
	SDL_putenv("SDL_KEYBOARDDRV=none");
...
{
	struct fb_fix_screeninfo finfo;
	struct fb_var_screeninfo vinfo, vinfoorig;
	int i;
	Uint32 Rmask;
	Uint32 Gmask;
	Uint32 Bmask;
	...
	ioctl(console_fd, FBIOGET_VSCREENINFO, &vinfoorig);
